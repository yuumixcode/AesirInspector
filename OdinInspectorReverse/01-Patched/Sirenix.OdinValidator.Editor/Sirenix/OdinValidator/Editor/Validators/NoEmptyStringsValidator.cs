...
{
	public class NoEmptyStringsValidator : ValueValidator<string>, IDefinesGenericMenuItems
	{
		...
		{
			if (Filter() && base.ValueEntry.SmartValue.IsNullOrWhitespace() && base.Property.GetAttribute<OptionalAttribute>() == null)
			{
				result.Add(ValidatorSeverity, "\"" + base.Property.NiceName + "\" should not be empty.");
			}
		}
		...
		public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
		{
			...
			{
				ValidationSessionEditor.OpenRuleSettingsWindow(typeof(NoEmptyStringsValidator), ConfigSourceType.Local);
			});
			genericMenu.AddItem(new GUIContent("See Rule Settings/For everyone"), on: false, delegate
			{
				ValidationSessionEditor.OpenRuleSettingsWindow(typeof(NoEmptyStringsValidator), ConfigSourceType.Project);
			});
		}
	}
}
