...
namespace Sirenix.OdinInspector
{
	...
	public class HorizontalGroupAttribute : PropertyGroupAttribute
	{
		...
		protected override void CombineValuesWith(PropertyGroupAttribute other)
		{
			...
			{
				Title = Title ?? hGroup.Title;
				DisableAutomaticLabelWidth = DisableAutomaticLabelWidth || hGroup.DisableAutomaticLabelWidth;
				if (LabelWidth == 0f && hGroup.LabelWidth != 0f)
				{
					LabelWidth = hGroup.LabelWidth;
				}
				if (hGroup.Gap != 3f)
				{
					Gap = hGroup.Gap;
