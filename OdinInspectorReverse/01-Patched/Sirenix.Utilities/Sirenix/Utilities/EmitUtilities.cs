...
namespace Sirenix.Utilities
{
	...
	public static class EmitUtilities
	{
		...
		{
			if (member.DeclaringType != null && (member.DeclaringType.Assembly == EditorAssembly || member.DeclaringType.Assembly == EngineAssembly))
			{
				return !typeof(Attribute).IsAssignableFrom(member.DeclaringType);
			}
			return false;
		}
