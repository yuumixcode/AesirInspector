namespace Sirenix.OdinInspector.Editor
{
	...
	public static class PersistentContext
	{
		...
		{
			context = PersistentContextCache.Instance.GetContext<TValue>(alphaKey.GetHashCode(), 0, 0, 0, 0, out var isNew);
			return isNew;
		}
		...
		{
			context = PersistentContextCache.Instance.GetContext<TValue>(alphaKey.GetHashCode(), betaKey.GetHashCode(), 0, 0, 0, out var isNew);
			return isNew;
		}
		...
		{
			context = PersistentContextCache.Instance.GetContext<TValue>(alphaKey.GetHashCode(), betaKey.GetHashCode(), gammaKey.GetHashCode(), 0, 0, out var isNew);
			return isNew;
		}
		...
		{
			context = PersistentContextCache.Instance.GetContext<TValue>(alphaKey.GetHashCode(), betaKey.GetHashCode(), gammaKey.GetHashCode(), deltaKey.GetHashCode(), 0, out var isNew);
			return isNew;
		}
		...
		{
			context = PersistentContextCache.Instance.GetContext<TValue>(alphaKey.GetHashCode(), betaKey.GetHashCode(), gammaKey.GetHashCode(), deltaKey.GetHashCode(), epsilonKey.GetHashCode(), out var isNew);
			return isNew;
		}
		...
		{
			return LocalPersistentContext<TValue>.Create(Get(alphaKey, defaultValue));
		}
		...
		{
			return LocalPersistentContext<TValue>.Create(Get(alphaKey, betaKey, defaultValue));
		}
		...
		{
			return LocalPersistentContext<TValue>.Create(Get(alphaKey, betaKey, gammaKey, defaultValue));
		}
		...
		{
			return LocalPersistentContext<TValue>.Create(Get(alphaKey, betaKey, gammaKey, deltaKey, defaultValue));
		}
		...
		{
			return LocalPersistentContext<TValue>.Create(Get(alphaKey, betaKey, gammaKey, deltaKey, epsilonKey, defaultValue));
		}
		...
		public static bool GetLocal<TKey1, TValue>(TKey1 alphaKey, out LocalPersistentContext<TValue> context)
		{
			...
			bool isNew = Get(alphaKey, out global);
