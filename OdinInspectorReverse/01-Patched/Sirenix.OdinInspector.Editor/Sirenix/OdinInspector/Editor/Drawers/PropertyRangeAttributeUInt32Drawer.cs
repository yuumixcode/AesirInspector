...
namespace Sirenix.OdinInspector.Editor.Drawers
{
	...
	public sealed class PropertyRangeAttributeUInt32Drawer : OdinAttributeDrawer<PropertyRangeAttribute, uint>
	{
		...
		{
			uint min = ((getterMinValue != null) ? getterMinValue.GetValue() : ((uint)base.Attribute.Min));
			uint max = ((getterMaxValue != null) ? getterMaxValue.GetValue() : ((uint)base.Attribute.Max));
