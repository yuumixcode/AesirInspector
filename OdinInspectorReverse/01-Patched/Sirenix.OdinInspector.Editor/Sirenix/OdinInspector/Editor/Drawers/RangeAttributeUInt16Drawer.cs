...
namespace Sirenix.OdinInspector.Editor.Drawers
{
	...
	public sealed class RangeAttributeUInt16Drawer : OdinAttributeDrawer<RangeAttribute, ushort>
	{
		...
		{
			IPropertyValueEntry<ushort> entry = base.ValueEntry;
			RangeAttribute attribute = base.Attribute;
			EditorGUI.BeginChangeCheck();
			int value = SirenixEditorFields.RangeIntField(label, entry.SmartValue, Math.Max(0, (int)attribute.min), Math.Min(65535, (int)attribute.max));
