...
namespace Sirenix.OdinInspector.Editor.ValueResolvers
{
	...
	public abstract class ValueResolver
	{
		...
		{
			return ValueResolverCreator.GetResolver(property, resolvedString, resolvedString);
		}
		...
		{
			return ValueResolverCreator.GetResolver(property, resolvedString, resolvedString, namedArgs);
		}
		...
		{
			return ValueResolverCreator.GetResolver(property, resolvedString, fallbackValue);
		}
		...
		{
			return ValueResolverCreator.GetResolver(property, resolvedString, fallbackValue, namedArgs);
		}
		...
		{
			return GetCombinedErrors(r1, r2, r3, r4, r5, r6, r7, r8, (ValueResolver[])null);
		}
		...
		{
			DrawErrors(r1, r2, r3, r4, r5, r6, r7, r8, (ValueResolver[])null);
		}
	...
	public sealed class ValueResolver<TResult> : ValueResolver
	{
		...
		/// </summary>
		public override Type ValueType => typeof(TResult);
		...
		public TResult GetValue(int selectionIndex = 0)
		{
			...
			try
			{
				TResult result = Func(ref Context, selectionIndex);
			...
			catch (Exception innerException)
			{
				...
				if (innerException.IsExitGUIException())
				{
					throw innerException.AsExitGUIException();
				}
				if (Event.current.type == EventType.Repaint)
				{
					Context.ErrorMessage = "Value resolution threw an exception: " + innerException.Message + "\n\n" + innerException.StackTrace;
