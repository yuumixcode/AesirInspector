...
namespace Sirenix.OdinInspector.Editor
{
	...
	public abstract class OdinDrawer
	{
		...
		protected virtual void DrawPropertyLayout(GUIContent label)
		{
			if (label != null)
			{
				EditorGUILayout.LabelField(label, new GUIContent("The DrawPropertyLayout method has not been implemented for the drawer of type '" + GetType().GetNiceName() + "', or you are calling base.DrawPropertyLayout(label), which you shouldn't."));
			}
			else
			{
				EditorGUILayout.LabelField(new GUIContent("The DrawPropertyLayout method has not been implemented for the drawer of type '" + GetType().GetNiceName() + "', or you are calling base.DrawPropertyLayout(label), which you shouldn't."));
			}
		}
		...
		protected bool CallNextDrawer(GUIContent label)
		{
			...
			if (property.ValueEntry != null)
			{
				...
				if (label == null)
				{
					GUI.Label(rect, Property.NiceName);
				}
				else
				{
