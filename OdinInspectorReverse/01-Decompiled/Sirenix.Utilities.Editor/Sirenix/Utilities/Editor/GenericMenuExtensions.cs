...
namespace Sirenix.Utilities.Editor
{
	...
	public static class GenericMenuExtensions
	{
		...
		{
			GenericMenu_MenuItems = typeof(GenericMenu).GetField("menuItems", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
			Type menuItemType = typeof(GenericMenu).GetNestedType("MenuItem", BindingFlags.Public | BindingFlags.NonPublic);
			if (menuItemType != null)
			{
				MenuItem_Content = menuItemType.GetField("content", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
				MenuItem_Func = menuItemType.GetField("func", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
				MenuItem_Func2 = menuItemType.GetField("func2", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
				MenuItem_On = menuItemType.GetField("on", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
			}
