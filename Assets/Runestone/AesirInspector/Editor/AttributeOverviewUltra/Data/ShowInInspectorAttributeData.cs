namespace Runestone.AesirInspector.Editor
{
    ...
    internal class ShowInInspectorAttributeData : AbstractAttributeData
    {
        ...
        public override BilingualData[] UsageTips { get; set; } =
        {
            ...
            new BilingualData(
                "只负责显示，不会序列化：仅用 [ShowInInspector] 的成员改动不会被保存，需配合 [SerializeField] 或 [OdinSerialize]。",
            ...
            new BilingualData(
                "常与 [ReadOnly] 组合，用于实时查看调试值（如 [ShowInInspector, ReadOnly] private int currentHealth;）。",
