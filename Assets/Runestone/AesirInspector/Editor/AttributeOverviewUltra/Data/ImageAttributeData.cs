...
namespace Runestone.AesirInspector.Editor
{
    ...
    internal class ImageAttributeData : AbstractAttributeData
    {
        ...
        {
            new AttributeExamplePreviewItem().InitializeUnitySerializedExample("Sources",
                ImageExampleSO.Instance),
            new AttributeExamplePreviewItem().InitializeUnitySerializedExample("Layout",
                ImageLayoutExampleSO.Instance),
            new AttributeExamplePreviewItem().InitializeUnitySerializedExample("Rendering",
                ImageRenderingExampleSO.Instance),
            new AttributeExamplePreviewItem().InitializeUnitySerializedExample("Class Attribute",
                ImageClassExampleSO.Instance),
            new AttributeExamplePreviewItem().InitializeUnitySerializedExample("Draw Property",
                ImageDrawPropertyExampleSO.Instance)
        };
    }
}
