...
namespace Runestone.AesirInspector.Editor
{
    ...
    public class TypeRegistryItemExampleSO : AttributeExampleSO<TypeRegistryItemExampleSO>
    {
        ...
        [TypeRegistryItem(null, null, SdfIconType.None, 0.3f, 0.1f, 0f, 0f, 0.8f, 0.3f, Name = "Brush",
            CategoryPath = PATH, Icon = SdfIconType.BrushFill, Priority = int.MinValue)]
        ...
        [TypeRegistryItem(null, null, SdfIconType.None, 0f, 0.3f, 0.1f, 0f, 0f, 0.8f, 0.3f,
            Name = "Paint Bucket", CategoryPath = PATH, Icon = SdfIconType.PaintBucket,
            Priority = int.MinValue)]
        ...
        [TypeRegistryItem(null, null, SdfIconType.None, 0f, 0.1f, 0.3f, 0f, 0f, 0.3f, 0.8f, Name = "Palette",
            CategoryPath = PATH, Icon = SdfIconType.PaletteFill, Priority = int.MinValue)]
