...
namespace Runestone.AesirInspector.Editor
{
    ...
    public class AssetSelectorExampleSO : AttributeExampleSO<AssetSelectorExampleSO>
    {
        ...
        [AssetSelector(Paths = "Assets/Runestone/AesirInspector/Editor/ExampleAssets/ScriptableObjects")]
        public ScriptableObject scriptableObjectsFromFolder;

        [FoldoutGroup("Parameter: Paths")]
        [AssetSelector(
            Paths = "Assets/Runestone/AesirInspector/Editor/ExampleAssets/Materials/Primary|" +
                    "Assets/Runestone/AesirInspector/Editor/ExampleAssets/Materials/Secondary")]
