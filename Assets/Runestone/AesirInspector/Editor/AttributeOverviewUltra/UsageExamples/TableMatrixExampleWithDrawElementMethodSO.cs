...
namespace Runestone.AesirInspector.Editor
{
        ...
        TableMatrixExampleWithDrawElementMethodSO>
    {
        ...
        [TableMatrix(HorizontalTitle = "Transposed Custom Cell Drawing",
            DrawElementMethod = "DrawClickableElement", ResizableColumns = false, RowHeight = 16,
            Transpose = true)]
        [ShowInInspector]
        ...
        bool DrawClickableElement(Rect rect, bool value)
        {
            ...
            EditorGUI.DrawRect(rect.Padding(1f),
                value ? new Color(0.1f, 0.8f, 0.2f) : new Color(0f, 0f, 0f, 0.5f));
            return value;
        }
