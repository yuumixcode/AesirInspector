...
namespace Runestone.AesirInspector.Editor
{
    ...
    public class TabGroupExampleSO : AttributeExampleSO<TabGroupExampleSO>
    {
        ...
        [FoldoutGroup("Parameter: TextColor, TabName")]
        [TabGroup("Parameter: TextColor, TabName/Tabs", "Stats", SdfIconType.BarChartLineFill, TextColor = "blue")]
        ...
        [FoldoutGroup("Parameter: TextColor, TabName")]
        [TabGroup("Parameter: TextColor, TabName/Tabs", "Quests", SdfIconType.Question, TextColor = "@questColor", TabName = "")]
        ...
        [TabGroup("Parameter: TabLayouting/Shrink Tabs", "Settings", SdfIconType.GearFill, TextColor = "grey")]
        ...
        [TabGroup("Parameter: TabLayouting/Shrink Tabs", "Character", SdfIconType.PersonFill, TextColor = "orange")]
        [TabGroup("Parameter: TabLayouting/Shrink Tabs", "World Map", SdfIconType.Map, TextColor = "orange", TabLayouting = TabLayouting.Shrink)]
        ...
        [TabGroup("Parameter: TabLayouting/Shrink Tabs", "Missions", SdfIconType.ExclamationSquareFill, TextColor = "yellow")]
        [TabGroup("Parameter: TabLayouting/Shrink Tabs", "Guide", SdfIconType.QuestionSquareFill, TextColor = "blue")]
        public float a;
        ...
        [FoldoutGroup("Parameter: TabLayouting")]
        [TabGroup("Parameter: TabLayouting/Multi Row Tabs", "Settings", SdfIconType.GearFill, TextColor = "grey")]
        ...
        [TabGroup("Parameter: TabLayouting/Multi Row Tabs", "Character", SdfIconType.PersonFill, TextColor = "orange")]
        [TabGroup("Parameter: TabLayouting/Multi Row Tabs", "Missions", SdfIconType.ExclamationSquareFill, TextColor = "yellow")]
        ...
        [TabGroup("Parameter: TabLayouting/Multi Row Tabs", "World Map", SdfIconType.Map, TextColor = "orange", TabLayouting = TabLayouting.MultiRow)]
        [TabGroup("Parameter: TabLayouting/Multi Row Tabs", "Collection 1", TextColor = "blue")]
        [TabGroup("Parameter: TabLayouting/Multi Row Tabs", "Guide", SdfIconType.QuestionSquareFill, TextColor = "blue")]
        public float e;
        ...
        [ResponsiveButtonGroup("Combining With Other Attributes/Tabs/Split/Buttons/Responsive/ResponsiveButtons")]
        public void Hello()
        {
        }
