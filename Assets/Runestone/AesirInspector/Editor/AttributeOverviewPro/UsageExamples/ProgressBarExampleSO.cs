...
namespace Runestone.AesirInspector.Editor
{
    ...
    internal class ProgressBarExampleSO : AttributeExampleSO<ProgressBarExampleSO>
    {
        ...
        [FoldoutGroup("Parameter: BackgroundColorGetter, DrawValueLabel")]
        [ProgressBar(0.0, 100.0, 0.15f, 0.47f, 0.74f, ColorGetter = "GetStackedHealthColor",
        ...
        Color GetHealthBarColor(float value) => Color.Lerp(Color.red, Color.green, Mathf.Pow(value / 100f, 2f));
