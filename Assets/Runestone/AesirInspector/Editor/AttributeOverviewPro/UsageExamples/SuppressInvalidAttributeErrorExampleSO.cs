...
namespace Runestone.AesirInspector.Editor
{
    ...
    /// </summary>
    [AesirExample]
    public class SuppressInvalidAttributeErrorExampleSO : AttributeExampleSO<SuppressInvalidAttributeErrorExampleSO>
    {
        ...
        {
            InvalidAttributeError = "This field will have an error box for the Range attribute on a string field.";
            SuppressedError = "The error has been suppressed on this field, and thus no error box will appear.";
        }
    }
}
